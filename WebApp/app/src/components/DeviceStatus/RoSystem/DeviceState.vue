...
onBeforeUnmount(async () : Promise<void> => await UnsubscribeToStateRequest());
...
async function SubscribeToStateRequest(): Promise<void> {
  await UnsubscribeToStateRequest();
...
async function UnsubscribeToStateRequest(): Promise<void> {
